...
const CREATE_INPUT = {
  bairro: "exampleBairro",
  cep: "exampleCep",
  cnpjcpf: "exampleCnpjcpf",
  codigoMunicipio: 42,
  codigoPais: 42,
  complemento: "exampleComplemento",
  createdAt: new Date(),
  email: "exampleEmail",
  id: "exampleId",
  inscricaoEstadual: "exampleInscricaoEstadual",
  logradouro: "exampleLogradouro",
  nomeFantasia: "exampleNomeFantasia",
  nomeMunicipio: "exampleNomeMunicipio",
  nomePais: "exampleNomePais",
  numero: "exampleNumero",
  razaoSocialNome: "exampleRazaoSocialNome",
